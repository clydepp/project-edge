...
module nios_system_mm_interconnect_0 (
	...
	wire  [12:0] cmd_mux_009_src_channel;                                                   // cmd_mux_009:src_channel -> hex3_s1_agent:cp_channel
	...
	wire  [12:0] cmd_mux_010_src_channel;                                                   // cmd_mux_010:src_channel -> hex4_s1_agent:cp_channel
	...
	wire  [12:0] cmd_mux_011_src_channel;                                                   // cmd_mux_011:src_channel -> hex5_s1_agent:cp_channel
	...
	wire         cmd_mux_012_src_valid;                                                     // cmd_mux_012:src_valid -> hex2_s1_agent:cp_valid
	wire  [95:0] cmd_mux_012_src_data;                                                      // cmd_mux_012:src_data -> hex2_s1_agent:cp_data
	wire         cmd_mux_012_src_ready;                                                     // hex2_s1_agent:cp_ready -> cmd_mux_012:src_ready
	wire  [12:0] cmd_mux_012_src_channel;                                                   // cmd_mux_012:src_channel -> hex2_s1_agent:cp_channel
	wire         cmd_mux_012_src_startofpacket;                                             // cmd_mux_012:src_startofpacket -> hex2_s1_agent:cp_startofpacket
	wire         cmd_mux_012_src_endofpacket;                                               // cmd_mux_012:src_endofpacket -> hex2_s1_agent:cp_endofpacket
	...
	wire         hex2_s1_agent_rp_valid;                                                    // hex2_s1_agent:rp_valid -> router_014:sink_valid
	wire  [95:0] hex2_s1_agent_rp_data;                                                     // hex2_s1_agent:rp_data -> router_014:sink_data
	wire         hex2_s1_agent_rp_ready;                                                    // router_014:sink_ready -> hex2_s1_agent:rp_ready
	wire         hex2_s1_agent_rp_startofpacket;                                            // hex2_s1_agent:rp_startofpacket -> router_014:sink_startofpacket
	wire         hex2_s1_agent_rp_endofpacket;                                              // hex2_s1_agent:rp_endofpacket -> router_014:sink_endofpacket
	...
	wire         hex2_s1_agent_rdata_fifo_src_valid;                                        // hex2_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_012:in_0_valid
	wire  [33:0] hex2_s1_agent_rdata_fifo_src_data;                                         // hex2_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_012:in_0_data
	wire         hex2_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_012:in_0_ready -> hex2_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_012_out_0_valid;                                         // avalon_st_adapter_012:out_0_valid -> hex2_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_012_out_0_data;                                          // avalon_st_adapter_012:out_0_data -> hex2_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_012_out_0_ready;                                         // hex2_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_012:out_0_ready
	wire   [0:0] avalon_st_adapter_012_out_0_error;                                         // avalon_st_adapter_012:out_0_error -> hex2_s1_agent:rdata_fifo_sink_error
