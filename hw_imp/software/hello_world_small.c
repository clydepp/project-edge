...
// Define the base address for your inference model's output
// You'll need to set this to the correct address in your system
#define INFERENCE_RESULT_BASE SWITCH_BASE  // Replace with actual inference result input base
...
void displayPredefinedWord(int inference_result);  // New function declaration
int checkInferenceResult();  // New function declaration
